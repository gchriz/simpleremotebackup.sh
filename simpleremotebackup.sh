...
# Optionally a rotating version strategy can be configured.
...
# Optional versioning strategy. There are many more possibilites.
# Choose one and comment out the others.
# Or create other types. Reading 'man date' may help.
#
...
#
# Example:
# On 'Sun Mar 6' the above four types of VERSIONDIR would produce:
#
#  data-backup/
#
#  ├── file1.txt
